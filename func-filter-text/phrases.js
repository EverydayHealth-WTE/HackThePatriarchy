...
exports.PositiveDatabase = {
    ...
    "sisterly love": { "BonusPoints": 1 },
    "commoner": { "BonusPoints": 1 },
    "cabin attendant": { "BonusPoints": 1 },
    "non-identical twins": { "BonusPoints": 1 },
    "founding mother": { "BonusPoints": 1 },
    "front woman": { "BonusPoints": 1 },
    "unwritten agreement": { "BonusPoints": 1 },
    "grandparent clause": { "BonusPoints": 1 },
    "lookout": { "BonusPoints": 1 },
    "honored attendant": { "BonusPoints": 1 },
    "nurse": { "BonusPoints": 1 },
    "woman of the house": { "BonusPoints": 1 },
    "passkey": { "BonusPoints": 1 },
    "robot": { "BonusPoints": 1 },
    "people working": { "BonusPoints": 1 },
    "modern people": { "BonusPoints": 1 },
    "superstition": { "BonusPoints": 1 },
    "returning child": { "BonusPoints": 1 },
    "trash collector": { "BonusPoints": 1 },
    "workers' compensation": { "BonusPoints": 1 },
    "elderly person": { "BonusPoints": 1 },
    "you all": { "BonusPoints": 1 },
    "hi all": { "BonusPoints": 1 },
    "hey all": { "BonusPoints": 1 },
    "those women": { "BonusPoints": 1 },
    "these women": { "BonusPoints": 1 }
    
};

exports.ProblematicSearchList = ["man and woman","boy and girl","men and women","boys and girls","husband and wife","husbands and wives","man and wife","son and daughter","sons and daughters","his and her","adam and eve","blind man","boss man","boss lady","brotherly love","cabin boy","choir boy","brew master","brotherly love","common man","confidence man","cabin boy","drum majorette","enlisted man","fall guy","fraternal twins","founding father","front man","gentlemen's agreement","grandfather clause","inside man","insurance man","jazz man","John Q. Public","king's ransom","learned man","lookout man","maid of honor","maintenance man","male nurse","man about town","man of action","man of distinction","man of the year","man on the street","man's best friend","man's work","man of the house","marked man","master key","master plan","master's degree","matron of honor","mechanical man","medicine man","men working","meter maid","modern man","mother lode","night watchman","office boy","old wives' tale","prodigal son","publicity man","Renaissance man","right-hand man","straw man","to a man","trash man","Uncle Sam","workman's compensation","little old lady","you guys","hi guys","hey guys","those guys","these guys","Faded beauty","her period","Ice queen","militant feminist","their period","your period"];
...
exports.ProblematicDatabase = {   
    ...
    "Uncle Sam": { GNReplacement: "United States", FemReplacement: "sunt sam", WarningMessage: "", ProblemPoints: 1 },
    ...
    "Faded beauty": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'Faded beauty', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 },
    "her period": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'her period', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 },
    "Ice queen": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'Ice queen', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 },
    "militant feminist": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'militant feminist', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 },
    "their period": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'their period', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 },
    "your period": { GNReplacement: "", FemReplacement: "", WarningMessage: "You've used the term 'your period', which is generally considered offensive in a gendered context. You should revise your phrasing.", ProblemPoints: 999999999 }
};